...
//
// Description:
///This file contains the "lin2DQuad8" linearized eight-node element declarations, 
///which defines an element in a finite element mesh.  
//------------------------------------------------------------------------------

#ifndef _LIN2DQUAD8_HPP_
#define _LIN2DQUAD8_HPP_
...
/// @brief     Class for creating a 2D linearized eight-node quadrilateral element in a mesh
class lin2DQuad8 : public Element{
    ...
    public:
        ...
        ///@note The mass matrix can be revisited in @ref linklin2DQuad8.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin2DQuad8.
        ...
        ///@note The damping matrix can be revisited in @ref linklin2DQuad8.
        ...
        ///@note The internal force vector can be revisited in @ref linklin2DQuad8.
