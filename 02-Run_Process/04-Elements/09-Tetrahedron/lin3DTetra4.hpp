...
//
// Description:
///This file contains the "lin3DTetra4" linearized eight-node element 
///declarations, which defines an element in a finite element mesh.
//------------------------------------------------------------------------------

#ifndef _LIN3DTETRA4_HPP_
#define _LIN3DTETRA4_HPP_
...
/// @date      March 12, 2021
/// @version   1.0
/// @file      lin3DTetra4.hpp
/// @class     lin3DTetra4
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 3D linearized four-node tetrahedron element in a mesh
class lin3DTetra4 : public Element{

    public:
        ///Creates a lin3DTetra4 in a finite element Mesh.
        ...
        ///@note More details can be found at @ref linklin3DTetra4.
        ///@see lin3DTetra4::theNodes, lin3DTetra4::theMaterial, lin3DTetra4::QuadraturePoints.
        lin3DTetra4(const std::vector<unsigned int> nodes, std::unique_ptr<Material> &material, const std::string quadrature="GAUSS", const unsigned int nGauss=4);

        ///Destroys this lin3DTetra4 object.
        ~lin3DTetra4();
        ...
        ///@note The mass matrix can be revisited in @ref linklin3DTetra4.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin3DTetra4.
        ...
        ///@note The damping matrix can be revisited in @ref linklin3DTetra4.
        ...
        ///@note The internal force vector can be revisited in @ref linklin3DTetra4.
