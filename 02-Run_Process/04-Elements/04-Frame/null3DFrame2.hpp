...
///which defines a frame-like element without any property.
//------------------------------------------------------------------------------

#ifndef _NULL3DFRAME2_HPP_
#define _NULL3DFRAME2_HPP_
...
/// @version   1.0
/// @file      null3DFrame2.hpp
/// @class     null3DFrame2
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 3D null frame element (no properties) in a mesh
class null3DFrame2 : public Element{

    public:
        ///Creates a null3DFrame2 in a finite element Mesh.
        ///@param nodes The Node connectivity array of this Element.
        ///@note More details can be found at @ref linknull3DFrame2.
        ///@see null3DFrame2::theNodes.
        null3DFrame2(const std::vector<unsigned int> nodes);

        ///Destroys this null3DFrame2 object.
        ~null3DFrame2();
        ...
        ///@note The mass matrix can be revisited in @ref linknull3DFrame2.
        ...
        ///@note The stiffness matrix can be revisited in @ref linknull3DFrame2.
        ...
        ///@note The damping matrix can be revisited in @ref linknull3DFrame2.
        ...
        ///@note The internal force vector can be revisited in @ref linknull3DFrame2.
