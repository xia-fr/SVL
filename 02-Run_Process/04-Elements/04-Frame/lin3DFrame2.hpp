...
#ifndef _LIN3DFRAME2_HPP_
#define _LIN3DFRAME2_HPP_
...
/// @date      March 13, 2019
/// @version   1.0
/// @file      lin3DFrame2.hpp
/// @class     lin3DFrame2
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 3D linearized two-node frame element in a mesh
class lin3DFrame2 : public Element{
    ...
    public:
        ...
        ///@note More details can be found at @ref linklin3DFrame2.
        ///@see lin3DFrame2::theNodes, lin3DFrame2::theSection, lin3DFrame2::QuadraturePoints.
        ...
        ///@note The mass matrix can be revisited in @ref linklin3DFrame2.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin3DFrame2.
        ...
        ///@note The damping matrix can be revisited in @ref linklin3DFrame2.
        ...
        ///@note The internal force vector can be revisited in @ref linklin3DFrame2.
    ...
    private:    
        ...
        ///@note Axes transformation are according to @ref linklin3DFrame2.
