...
//
// Description:
///This file contains the "lin3DTruss2" linearized two-node element 
///declarations, which defines an element in a finite element mesh. 
//------------------------------------------------------------------------------

#ifndef _LIN3DTRUSS2_HPP_
#define _LIN3DTRUSS2_HPP_
...
/// @version   1.0
/// @file      lin3DTruss2.hpp
/// @class     lin3DTruss2
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 3D linearized two-node truss element in a mesh
class lin3DTruss2 : public Element{
    ...
    public:
        ...
        ///@note More details can be found at @ref linklin3DTruss2.
        ///@see lin3DTruss2::theNodes, lin3DTruss2::theMaterial, lin3DTruss2::QuadraturePoints.
        ...
        ///@note The mass matrix can be revisited in @ref linklin3DTruss2.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin3DTruss2.
        ...
        ///@note The damping matrix can be revisited in @ref linklin3DTruss2.
        ...
        ///@note The internal force vector can be revisited in @ref linklin3DTruss2.
    ...
    private:    
        ...
        ///@note The x1-axis transformation is according to @ref linklin3DTruss2.
        ...
        ///@note Axes transformation are according to @ref linklin3DTruss2.
