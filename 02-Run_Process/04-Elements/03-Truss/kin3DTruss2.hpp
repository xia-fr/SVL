...
//
// References : 
//  [1] 3D Co-rotational Truss Formulation, Louie L. Yaw, E. F. Cross School of 
//      Engineering, Walla Walla University, November 28, 2011. 
//
// Description:
///This file contains the "kin3DTruss2" kinematic two-node element declarations, 
///which defines an element in a finite element mesh
//------------------------------------------------------------------------------

#ifndef _KIN3DTRUSS2_HPP_
#define _KIN3DTRUSS2_HPP_
...
/// @date      May 10, 2019
/// @version   1.0
/// @file      kin3DTruss2.hpp
/// @class     kin3DTruss2
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 3D finite kinematic two-node truss element in a mesh
class kin3DTruss2 : public Element{
    ...
    public:
        ...
        ///@note The mass matrix can be revisited in @ref linkkin3DTruss2.
        ...
        ///@note The stiffness matrix can be revisited in @ref linkkin3DTruss2.
        ...
        ///@note The damping matrix can be revisited in @ref linkkin3DTruss2.
        ...
        ///@note The internal force vector can be revisited in @ref linkkin3DTruss2.
    ...
    private:    
        ...
        ///@note Axes transformation are according to @ref linkkin3DTruss2.
        ...
        ///@return Vector with the strain at Element cnter.
