...
//
// Description:
///This file contains the "lin2DTria6" linearized six-node element 
///declarations, which defines an element in a finite element mesh. 
//------------------------------------------------------------------------------

#ifndef _LIN2DTRIA6_HPP_
#define _LIN2DTRIA6_HPP_
...
/// @brief     Class for creating a 2D linearized six-node triangular element in a mesh
class lin2DTria6 : public Element{
    ...
    public:
        ...
        ///@param th The thickness of the lin2DTria6 Element.
        ///@param quadrature The integration rule to be employed.
        ///@param nGauss Number of Gauss points for Element integration.
        ///@note More details can be found at @ref linklin2DTria6.
        ///@see lin2DTria6::theNodes, lin2DTria6::theMaterial, lin2DTria6::QuadraturePoints.
        ...
        ///@note The mass matrix can be revisited in @ref linklin2DTria6.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin2DTria6.
        ...
        ///@note The damping matrix can be revisited in @ref linklin2DTria6.
        ...
        ///@note The internal force vector can be revisited in @ref linklin2DTria6.
        ...
        ///@note The surface force vector can be revisited in @ref linklin2DTria6.
        ...
        ///@return Vector with the Element surface force.
        ///@note The body force vector can be revisited in @ref linklin2DTria6.
        ///@see Assembler::ComputeExternalForceVector(), Integrator::ComputeEffectiveForce().
        ...
        ///@note The DRM force vector can be revisited in @ref linklin2DTria6.
        ///@see Assembler::ComputeExternalForceVector(), Integrator::ComputeEffectiveForce().
