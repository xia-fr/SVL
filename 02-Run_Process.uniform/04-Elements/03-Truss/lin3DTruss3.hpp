...
//
// References : 
//  [1] Bathe, K. Jurgen, "Finite Element Procedures", Chapter 5: pages 339-340 
//      (example 5.2: in 348-349). Prentice-Hall, 1996. 
//
// Description:
///This file contains the "lin3DTruss3" linearized three-node element 
///declarations, which defines an element in a finite element mesh.
//------------------------------------------------------------------------------

#ifndef _LIN3DTRUSS3_HPP_
#define _LIN3DTRUSS3_HPP_
...
/// @date      April 23, 2020
/// @version   1.0
/// @file      lin3DTruss3.hpp
/// @class     lin3DTruss3
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 3D linearized three-node truss element in a mesh
class lin3DTruss3 : public Element{

    public:
        ///Creates a lin3DTruss3 in a finite element Mesh.
        ...
        ///@note More details can be found at @ref linklin3DTruss3.
        ///@see lin3DTruss3::theNodes, lin3DTruss3::theMaterial, lin3DTruss3::QuadraturePoints.
        lin3DTruss3(const std::vector<unsigned int> nodes, std::unique_ptr<Material> &material, const double area, const std::string quadrature="GAUSS", const unsigned int nGauss=3);

        ///Destroys this lin3DTruss3 object.
        ~lin3DTruss3();
        ...
        ///@note The mass matrix can be revisited in @ref linklin3DTruss3.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin3DTruss3.
        ...
        ///@note The damping matrix can be revisited in @ref linklin3DTruss3.
        ...
        ///@note The internal force vector can be revisited in @ref linklin3DTruss3.
    ...
    private:    
        ...
        ///@note The x1-axis transformation is according to @ref linklin3DTruss3.
        ...
        ///@note Axes transformation are according to @ref linklin3DTruss3.
        ...
        ///@param ri The i-th Gauss coordinate in the r-axis.
        ///@param Jij The Jacobian matrix evaluated at (ri).
