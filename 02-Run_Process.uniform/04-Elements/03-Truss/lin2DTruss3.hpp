...
//
// Description:
///This file contains the "lin2DTruss3" linearized three-node element 
///declarations, which defines an element in a finite element mesh.
//------------------------------------------------------------------------------

#ifndef _LIN2DTRUSS3_HPP_
#define _LIN2DTRUSS3_HPP_
...
/// @date      April 24, 2020
/// @version   1.0
/// @file      lin2DTruss3.hpp
/// @class     lin2DTruss3
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 2D linearized three-node truss element in a mesh
class lin2DTruss3 : public Element{
    ...
    public:
        ...
        ///@note The mass matrix can be revisited in @ref linklin2DTruss3.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin2DTruss3.
        ...
        ///@note The damping matrix can be revisited in @ref linklin2DTruss3.
        ...
        ///@note The internal force vector can be revisited in @ref linklin2DTruss3.
    ...
    private:    
        ...
        ///@note The x1-axis transformation is according to @ref linklin2DTruss3.
        ...
        ///@note Axes transformation are according to @ref linklin2DTruss3.
