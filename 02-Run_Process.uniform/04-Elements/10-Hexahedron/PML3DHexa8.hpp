...
#ifndef _PML3DHEXA8_HPP_
#define _PML3DHEXA8_HPP_
...
/// @brief     Class for creating a 3D linearized eight-node perfectly matched layer element in a mesh
class PML3DHexa8 : public Element{
    ...
    public:
        ...
        ///@note The mass matrix can be revisited in @ref linkPML3DHexa8.
        ...
        ///@note The stiffness matrix can be revisited in @ref linkPML3DHexa8.
        ...
        ///@note The damping matrix can be revisited in @ref linkPML3DHexa8.
        ...
        ///@note The internal force vector can be revisited in @ref linkPML3DHexa8.
