...
//
// Description:
///This file contains the "lin3DHexa20" linearized twenty-node element 
///declarations, which defines an element in a finite element mesh.
//------------------------------------------------------------------------------

#ifndef _LIN3DHEXA20_HPP_
#define _LIN3DHEXA20_HPP_
...
/// @date      April 4, 2018
/// @version   1.0
/// @file      lin3DHexa20.hpp
/// @class     lin3DHexa20
/// @see       Element.hpp Mesh.hpp
/// @brief     Class for creating a 3D linearized twenty-node hexahedron element in a mesh
class lin3DHexa20 : public Element{

    public:
        ///Creates a lin3DHexa20 in a finite element Mesh.
        ...
        lin3DHexa20(const std::vector<unsigned int> nodes, std::unique_ptr<Material> &material, const std::string quadrature="GAUSS", const unsigned int nGauss=27);
        ...
        ///@note The mass matrix can be revisited in @ref linklin3DHexa20.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin3DHexa20.
        ...
        ///@note The damping matrix can be revisited in @ref linklin3DHexa20.
        ...
        ///@note The internal force vector can be revisited in @ref linklin3DHexa20.
