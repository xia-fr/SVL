...
//
// Description:
///This file contains the "lin2DQuad4" linearized four-node element 
///declarations, which defines an element in a finite element mesh. 
//------------------------------------------------------------------------------

#ifndef _LIN2DQUAD4_HPP_
#define _LIN2DQUAD4_HPP_
...
/// @brief     Class for creating a 2D linearized four-node quadrilateral element in a mesh
class lin2DQuad4 : public Element{

    public:
        ///Creates a lin2DQuad4 in a finite element Mesh.
        ...
        ///@note More details can be found at @ref linklin2DQuad4.
        ///@see lin2DQuad4::theNodes, lin2DQuad4::theMaterial, lin2DQuad4::QuadraturePoints.
        lin2DQuad4(const std::vector<unsigned int> nodes, std::unique_ptr<Material> &material, const double th, const std::string quadrature="GAUSS", const unsigned int nGauss=4);

        ///Destroys this lin2DQuad4 object.
        ~lin2DQuad4();
        ...
        ///@note The mass matrix can be revisited in @ref linklin2DQuad4.
        ...
        ///@note The stiffness matrix can be revisited in @ref linklin2DQuad4.
        ...
        ///@note The damping matrix can be revisited in @ref linklin2DQuad4.
        ...
        ///@note The internal force vector can be revisited in @ref linklin2DQuad4.
        ...
        ///@note The surface force vector can be revisited in @ref linklin2DQuad4.
        ...
        ///@return Vector with the Element surface force.
        ///@note The body force vector can be revisited in @ref linklin2DQuad4.
        ///@see Assembler::ComputeExternalForceVector(), Integrator::ComputeEffectiveForce().
        ...
        ///@note The DRM force vector can be revisited in @ref linklin2DQuad4.
        ///@see Assembler::ComputeExternalForceVector(), Integrator::ComputeEffectiveForce().
    ...
    private:
        ...
        ///The Damping model.
        std::vector<std::unique_ptr<Damping> > theDamping;
